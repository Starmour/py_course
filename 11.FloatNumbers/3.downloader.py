...
while True:
  file_size = int(input("Please, enter the file size:\n>"))
  dl_speed = int(input("Please, enter the download speed:\n>"))
  for sec in range (math.ceil(file_size / dl_speed)):
    sec += 1
    downloaded = dl_speed * sec
    print(f"Spent {sec} sec. Downloaded {downloaded} from {file_size} ({downloaded/ file_size * 100} %)")
    if file_size - downloaded < dl_speed:
      sec += 1
